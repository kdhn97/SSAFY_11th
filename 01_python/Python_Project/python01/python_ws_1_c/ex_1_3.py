...
third_word1 = password[66:69]
third_word2 = third_word1[::-1]
fourth_word1 = password[322:326]
fourth_word2 = fourth_word1[::-1]
fifth_word = password[365:371]

print(f'{first_char} {second_word} {third_word2} {fourth_word2} "{fifth_word}".')